...
{
    IsUnselectable?: boolean|Binding
}
...
export class RadioButton extends ToggleButtonBase<IRadioButtonProps, IRadioButtonState>
{
    ...
    static DefaultStyle = new WebStyle<IRadioButtonProps>(
        ...
        },
        {
            ...
            [`@ .${RadioButton.RootClassName}`]: {
                ...
                padding: Theme.Value(ThemeLayout.StandardBorder), // TemplateProp(nameof<IRadioButtonProps>(p => p.Padding)),
                borderColor: TemplateProp(nameof<IRadioButtonProps>(p => p.BorderBrush)),
                borderWidth: Theme.Value(ThemeLayout.StandardBorder), // TemplateProp(nameof<IRadioButtonProps>(p => p.BorderThickness)),
            ...
            [`@ .${RadioButton.FillClassName}`]: {
                backgroundColor: Theme.Value(SemanticColor.InputBackgroundChecked),
                height: `calc(${Theme.Value(FontStyle.Glyph1x)} - 6px)`,
                width: `calc(${Theme.Value(FontStyle.Glyph1x)} - 6px)`,
            ...
            [`@.${ToggleButton.STATE_ValidationError} .${RadioButton.FillClassName}`]: {
                backgroundColor: Theme.Value(SemanticColor.Error),
            },
    ...
    public /* override */ OnClick(e?: React.MouseEvent): void
    {
