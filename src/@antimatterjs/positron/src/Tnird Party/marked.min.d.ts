...
export declare function marked(src: string, options: MarkedOptions & { async: false }): string;
export declare function marked(src: string, options: MarkedOptions & { async: true }): Promise<string>;
...
declare global
{
    const marked: {
        ...
        use(...args: Partial<MarkedOptions>[]): void;
