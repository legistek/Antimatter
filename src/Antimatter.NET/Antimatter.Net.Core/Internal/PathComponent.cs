...
namespace Antimatter.Net.Internal
{
    internal class PathComponent
    {
        ...
        internal WeakReference<object> _lastPropertySource;
        ...
        internal void OnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            this.Binding?.OnSourcePropertyChanged(this.Index);
        }
        ...
        internal object GetValue()
        {
            if (this.LastPropertySource == null)
                return null;
            return this.PropertyKey?.GetValue(this.LastPropertySource, this);
        }

        internal void OnTargetPropertyChanged(object value, Reactor reactor)
        {
            ...
            if (lastPropertySource != null)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        Reactor.DebugWriteLine(ex.InnerException);
                    }
