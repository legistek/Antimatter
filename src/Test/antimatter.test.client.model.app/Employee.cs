...
{
    public class Employee : ObservableObject, IObservableTreeNode<Employee>
    {
        ...
        INotifyCollectionChanged IObservableTreeNode<Employee>.Children => this.Underlings;

        int IObservableTreeNode<Employee>.Size { get; set; }

        public bool CanExpand => this.Underlings?.Count > 0;

        Employee IObservableTreeNode<Employee>.Parent { get; set; }
        ...
        public int Level
        {
            ...
            {
                int i = 0;
                IObservableTreeNode<Employee> parent = this;
                do
                {
        ...
        public string MentionLink
        {
            get => @$"<a href=""user://{this.ID.ToString()}"">{this.FullName}</a>";
        }
