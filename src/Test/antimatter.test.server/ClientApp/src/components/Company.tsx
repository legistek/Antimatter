import { Binding, DataContext, AntimatterComponent, ModelObjectReference, BindingMode, Antimatter } from '@antimatterjs/react';
...
export class Employee extends View
{
    ...
    private _customBreadcrumbTemplate: DataTemplate = (item) => (
        ...
        return (
            ...
            >
                ...
                <StackPanel>
                    ...
                    <TextBlock
                        ContextMenuCommands={new Binding(nameof<Model.Employee>(e => e.Commands))}
                        Text="I have context!" />
                    ...
                    <CommandButton Command={new Binding("IncreaseAgeCommand")}
                        ContextMenuCommands={new Binding("Commands")}
            ...
            <Grid ColumnDefinitions={[Grid.ColumnDefinition(1, true), Grid.ColumnDefinition()]}
                ...
                <StackPanel>
                    ...
                    <CommandButton
                        ...
                        Command={() =>
                        {
                            Antimatter.Server.InvokeModelObjectMethod(
                                this.DataContext,
                                "HoboMethod",
                                ["You're a hobo"]);
                        }} />
                        ...
                        ItemTemplate={{
                            [WindowLayout.Default]: (item) => (
                                <StackPanel
                                    ...
                                    <TextBlock
                                        VerticalAlignment={VerticalAlignment.Center}
                                        Text={new Binding({ Path: "FullName", Source: item })}
