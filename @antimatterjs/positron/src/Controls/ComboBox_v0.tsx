...
export interface IComboBoxProps_v0 extends ISelectorProps
{
...
export interface IComboBoxState_v0 extends ISelectorState
{
    Label?: string,
...
export class ComboBoxBase_v0 extends Selector<IComboBoxProps_v0, IComboBoxState_v0>
{
    ...
    private static ItemTemplate_STATIC = new DataTemplate((item: any) => (
        <TextBlock
            ...
            OnClick={() => ComboBoxBase_v0.TestClick_Static('Templ')}
        />
    ));
    ...
    public static DefaultStyle: Style<IComboBoxProps_v0> = new Style<IComboBoxProps_v0>(
        {
            //SelectionMode: SelectionMode.Single,
            //ItemsSource: [],
            Template: new ControlTemplate((templatedParent: ComboBoxBase_v0) => templatedParent.Template),
...
export class ComboBox_v0 extends ComboBoxBase_v0 { }