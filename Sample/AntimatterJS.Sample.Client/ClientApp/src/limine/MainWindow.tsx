...
import { Window, Grid, HorizontalAlignment, VerticalAlignment, IWindowProps, ThemeColor } from '@antimatterjs/positron'
...
export class MainWindow extends Window<IMainWindowProps, {}>
{
    ...
    constructor(props)
    {
        ...
        this.SetValue(nameof(this.props.Background), ThemeColor.NeutralLighter);        
    }
