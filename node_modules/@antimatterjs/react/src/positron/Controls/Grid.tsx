...
export class Grid extends Panel<IGridProps, IGridState>
{    
    ...
    {
        if (!this.props.RowDefinitions || this.props.RowDefinitions.length === 0)
            return undefined;

        let rowTemplate: string = "";

        for (const row of this.props.RowDefinitions)
        {
    ...
    private ConstructGridColumnTemplate(): string|undefined
    {
        ...
        for (const column of this.props.ColumnDefinitions)
        {
