...
import { AntimatterComponent } from '../React/AntimatterComponent';
...
export class FrameworkElement<
    ...
    extends AntimatterComponent<P, S>
{
    render()
    {
    ...
    protected /* virtual */ getCSSStyles(): React.CSSProperties | undefined
    {
        return {
