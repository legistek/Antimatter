...
import { IPanelState, Panel, IPanelProps } from './Panel';
    ...
    extends Control<P, S>
{
    ...
    {
        return React.createElement(
            (this.props.ItemsPanel || StackPanel),
            {
